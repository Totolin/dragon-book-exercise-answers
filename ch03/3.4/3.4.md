...
Gives the language state transition diagram described in each regular expression in Exercise 3.3.2.

#### 解答


Answer the steps：NFA -> DFA -> Least state DFA（State transition graph）
...
1. a(a|b)*a
    ...
    Minimal state of DFA (state transition graph)::
    
    Combine indistinguishable states B and D
